...
class HttpStatus(Enum):
    """Flask and Flask-restful do not have declaration of variables for HTTP Status codes.
    For the sake of making code readable, descripting HTTP Status codes will be used by assigning variables to status codes"""
    continue_100 = 100
