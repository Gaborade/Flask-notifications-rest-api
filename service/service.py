...
class NotificationList(Resource):
    ...
    @marshal_with(notification_fields)
    def get(self):
        """Retrieving notification collection"""
    ...
    def post(self, id):
        ...
        parser.add_argument('notif_category', type=str, required=True, help='Notification category')
        args = parser.parse_args()
        notification = NotificationModel(
            message = args['message'],
            ttl = args['ttl'],
            creation_date = datetime.now(utc),
            notif_category = args['notif_category']
        )
